    ...
    <div id="loginWrapper">
        <div id="loginBox">
            <div id="loginBox-head">
                <div id="loginBoxhead_img"><img src="{{ URL::asset('auth/images/campu1.png') }}" alt="" width="45" height="45" /></div>
                <h1>SISTEM INPORMASI AKADEMIK</h1>
            </div>
            <div id="loginBox-title">
                <h2>Portal Akademik</h2>
                <img src="{{ URL::asset('auth/images/loginBox-title-img.jpeg') }}" alt="">
            </div>
